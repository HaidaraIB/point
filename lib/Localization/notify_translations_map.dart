...
const Map<String, String> notifyTranslationsEn = {
  ...
  'notify.sample.edit_message': 'Please adjust the headline and colors.',
  'notify.sample.rejection_reason': 'Does not match brand guidelines.',
  'notify.sample.comment_preview': 'Looks good — minor tweaks only.',
  'notify.sample.extension_reason': 'Waiting for client feedback.',
  'notify.sample.denial_note': 'Deadline cannot be extended.',
  'notify.sample.priority_medium': 'Medium',
...
const Map<String, String> notifyTranslationsAr = {
  ...
  'notify.sample.edit_message': 'يرجى تعديل العنوان والألوان.',
  'notify.sample.rejection_reason': 'لا يتوافق مع هوية العلامة.',
  'notify.sample.comment_preview': 'جيد جداً — تعديلات بسيطة فقط.',
  'notify.sample.extension_reason': 'بانتظار ملاحظات العميل.',
  'notify.sample.denial_note': 'لا يمكن تمديد الموعد النهائي.',
  'notify.sample.priority_medium': 'متوسطة',
  'notify.mgr.completed.title':
