...
Future<void> showAddPublishDialog({MetaPostModel? existing}) async {
  ...
  if (existing != null) {
    ...
    postType.value = existing.postType.trim().isEmpty ? 'feed' : existing.postType;
    ...
    if (existingMedia != null && existingMedia.isNotEmpty) {
      ...
      mediaType.value = existing.mediaType ?? _publishMediaTypeFromUrl(existingMedia);
    } else {
      mediaUrl.value = null;
    ...
    clientId.value =
        (existingClient != null && existingClient.isNotEmpty) ? existingClient : noneClient;
              ...
              return SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                    Text(
                      existing == null ? 'publish.add_title'.tr : '${'edit'.tr} - ${'publish.add_title'.tr}',
                      ...
                      () => Wrap(
                        ...
                        children: [
                          ...
                          ChoiceChip(
                            ...
                            onSelected: (_) => scheduleMode.value = 'schedule',
                          ),
                        ],
                      ),
                    ),
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: InkWell(
                                        onTap: () {
                                          controller.uploadedFilesPaths.remove(fileUrl);
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        MainButton(
                          title: existing == null ? 'publish.save_draft'.tr : 'common.save'.tr,
                          height: 40,
                          borderSize: 20,
                          width: 140,
                          ...
                          onPressed: () async {
                            ...
                            final fs = _normalizePlatformsForFirestore(platforms);
                            if (fs.isEmpty) {
                              FunHelper.showSnackbar(
                                'error'.tr,
                            ...
                            final nextStatus = scheduleMode.value == 'schedule' ? 'scheduled' : 'created';
                            final post = MetaPostModel(
                              ...
                              platforms: fs,
                              status: nextStatus,
                              clientId: clientId.value == noneClient ? null : clientId.value.trim(),
