...
void montageDiloag(BuildContext context, {TaskModel? model}) {
  ...
  final duration = TextEditingController(text: model?.monatageModel?.duration);
  final dimentaions = TextEditingController(
    text: model?.monatageModel?.dimentioans,
  );
  final categories = TextEditingController(
    text: model?.monatageModel?.category,
  );
