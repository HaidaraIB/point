...
- **النشر**:
  - ⏰ تذكير منشور خلال ١٥ دقيقة، ثم إن لم يُنشر تذكير متأخر بعد ١٥ دقيقة، ثم تذكير أخير بعد ١٥ دقيقة إضافية (المنفّذ إن وُجد، وإلا فريق النشر؛ يتخطّى المنشور والمرفوض؛ `publishSoonNotifiedAt` / `publishLateNotifiedAt` / `publishLateSecondNotifiedAt`).
...
1) **publish** (prod): كل ٥–١٠ دقائق — مثل `*/5 * * * *` — body prod أعلاه (نافذة ١٥ دقيقة قبل الموعد + تذكيران للتأخير؛ الكرون الساعي قد يفوّت المنشورات).  
